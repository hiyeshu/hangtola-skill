 ...
 * [OUTPUT]: 对外生成 site/index.html，并仅为部署站点注入 GitHub 入口与 Skill 用法复制控件
...
<nav id="site-meta" aria-label="Hangtola 项目与 Skill">
  <a class="site-meta-link" href="https://github.com/hiyeshu/hangtola-skill"
    ...
    <span>hiyeshu/hangtola-skill</span>
  </a>
  <button class="site-meta-copy" id="copy-skill-usage" type="button"
          title="复制安装命令和使用示例" aria-describedby="copy-skill-status">
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" aria-hidden="true">
      <rect x="8" y="8" width="11" height="11" rx="2"/>
      <path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v8a2 2 0 0 0 2 2h2"/>
    </svg>
    <span data-copy-label>复制 Skill 用法</span>
  </button>
...
<script>
(() => {
  const button = document.querySelector('#copy-skill-usage');
  if (!button) return;
  ...
  button.addEventListener('click', async () => {
    ...
    try {
      ...
      status.textContent = 'Skill 安装命令和使用示例已复制';
